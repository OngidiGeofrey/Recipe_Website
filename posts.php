...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">My Recipe Collection</h3>
        <div class="card-tools align-middle">
            <a class="btn btn-dark btn-sm py-1 rounded-0" href="./?page=manage_recipe" id="create_new">New Recipe</a>
        </div>
    </div>
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                ...
                <th class="text-center p-0">Recipe Image</th>
                <th class="text-center p-0">Date Created</th>
                <th class="text-center p-0">Recipe Details</th>
                <th class="text-center p-0">Status</th>
                <th class="text-center p-0">Posted By</th>
