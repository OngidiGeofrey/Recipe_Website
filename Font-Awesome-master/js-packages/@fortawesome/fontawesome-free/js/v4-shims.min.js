...
l = this, a = function() {
    ...
    ~r.indexOf("MSIE") || r.indexOf("Trident/"), "___FONT_AWESOME___"), t = function() {
        try {
            return "Vacancyion" === process.env.NODE_ENV;
        } catch (l) {
            return !1;
        }
    }();
